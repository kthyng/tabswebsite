...
def read_model(buoy, which, dstart, dend, timing='recent', units='Metric',
    ...
    if timing == 'hindcast':
        ...
        locs = ['http://terrebonne.tamu.edu:8080/thredds/dodsC/forecast_latest2/roms_stn_f_latest.nc',
                'http://terrebonne.tamu.edu:8080/thredds/dodsC/forecast_latest/roms_stn_f_latest.nc',
