...
<div id="container">
    ...
    <ul>
    <l><b>Buoyname:</b> B, D, etc</l><br>
    <l><b>table:</b> ven (water currents, temperature), met (wind direction, temperature), wave (wave properties), salt (water properties, salt, temperature), eng (buoy function properties)</l><br>
    <l><b>datepicker:</b> single date (e.g. 2017/1/23 or 2017-1-23) or date range (e.g. 2017-1-23+-+2017-1-30)</l><br>
    <l><b>Datatype:</b> data (to get a table of data), pic (to get an image), download (to only download the data)</l><br>
    <l><b>units:</b> 'M' (metric, default) or 'E' (English)</l><br>
    <l><b>tz:</b> 'UTC' (GMT, default) or 'central' (local Texas/buoy time)</l><br>
    <ul>
